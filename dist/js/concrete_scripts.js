$(function() {
    ...
    $(".recommendations-grid-bottom").on('mouseenter', '.single-product-collected-container-max-width', function() {
        console.log("Hovered");
        const direct_link = `concrete.html?item=${$(this).attr('item-id')}`;
    ...
    $('.recommendations-grid-bottom').on('mouseleave', '.single-product-collected-container-max-width', function() {
